                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center gap-4">
                    <Link href="/" className="flex items-center gap-3 shrink-0 group outline-none">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] sm:text-xs text-teal-600 font-bold tracking-widest uppercase">MS OBGY | MBBS</p>
                        </div>
                    </Link>

                    <Link href="/" className="inline-flex items-center gap-2 px-4.5 py-2 rounded-full bg-teal-50 text-teal-700 font-bold text-xs sm:text-sm hover:bg-teal-100 transition shadow-sm border border-teal-100/50 outline-none">
